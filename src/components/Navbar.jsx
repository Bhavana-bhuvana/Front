...
//     { id: "press", label: "Press Releases", type: "scroll" },
//     { id: "contact", label: "Contact Us", type: "route" },
//   ];
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { id: "publications", label: "Publications", type: "scroll" },
    { id: "press", label: "Press Releases", type: "scroll" },
    { id: "contact", label: "Contact Us", type: "modal" }, // changed type
  ];
      ...
      {navItems.map((item) => (
        <li key={item.id}>
          <motion.a
            ...
            onClick={(e) => handleClick(item, e)}
            className={`text-white hover:text-[#34d399] transition-colors duration-300 ${
              activeSection === item.id ? "font-bold text-[#06a055]" : ""
            }`}
          >
            {item.label}
          </motion.a>
