        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="border p-3 rounded-lg w-full h-32 focus:ring-2 focus:ring-purple-400 transition"
          ...
          <button
            type="submit"
            disabled={sending}
            className="bg-gradient-to-r from-purple-600 to-pink-500 text-white px-6 py-3 rounded-full font-semibold hover:from-purple-700 hover:to-pink-600 transition w-full"
          >
