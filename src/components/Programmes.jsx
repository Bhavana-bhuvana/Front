...
// const Programmes = ({ isAdmin = false }) => {
...
//                   {prog.title}
//                 </h3>
//                 <p className="text-white text-sm mb-2 break-words break-all whitespace-normal line-clamp-3">
//                   {prog.description}
//                 </p>
            ...
            {editingProg === prog._id ? (
              ...
              <>
                ...
                <Link to={`/programmes/${prog._id}`} className="w-full text-center">
                  ...
                  <p className="text-white text-sm mb-2 break-words whitespace-normal line-clamp-3">
                    {prog.description}
                  </p>
                </Link>
